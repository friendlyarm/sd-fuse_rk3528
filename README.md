...
* pre-built partition image: In the directory "03_Partition image files" of [NetDrive](https://download.friendlyelec.com/rk3528), or download from [server](https://downloads.friendlyelec.com/os-images/rk3528/images)
* compressed root file system tar ball: In the directory "06_File systems" of [NetDrive](https://download.friendlyelec.com/rk3528), or download from [server](https://downloads.friendlyelec.com/rootfs/rk3528)
...
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3528/images):
```
...
wget https://downloads.friendlyelec.com/os-images/rk3528/images/debian-trixie-core-arm64-images.tgz
...
```
out/rk3528-sd-debian-trixie-core-6.1-arm64-YYYYMMDD.img
```
...
*Note: Here we use debian-trixie system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3528/images), here you need to download the debian-trixie and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/rk3528/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3528 -b kernel-6.1.y --single-branch sd-fuse_rk3528-kernel6.1
cd sd-fuse_rk3528-kernel6.1
wget https://downloads.friendlyelec.com/os-images/rk3528/images/debian-trixie-core-arm64-images.tgz
tar xvzf debian-trixie-core-arm64-images.tgz
wget https://downloads.friendlyelec.com/os-images/rk3528/images/emmc-flasher-images.tgz
...
```
out/rk3528-eflasher-debian-trixie-core-6.1-arm64-YYYYMMDD.img
```
...
```
wget https://downloads.friendlyelec.com/rootfs/rk3528/rootfs-debian-trixie-core-arm64.tgz
wget https://downloads.friendlyelec.com/rootfs/rk3528/rootfs-debian-trixie-core-arm64.tgz.sha256
