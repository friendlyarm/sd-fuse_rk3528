...
wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/openmediavault-arm64-images.tgz
tar xzf openmediavault-arm64-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/debian-trixie-core-arm64-images.tgz
tar xzf debian-trixie-core-arm64-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/friendlywrt23-images.tgz
tar xzf friendlywrt23-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/friendlywrt23-docker-images.tgz
tar xzf friendlywrt23-docker-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/friendlywrt21-images.tgz
tar xzf friendlywrt21-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/friendlywrt21-docker-images.tgz
tar xzf friendlywrt21-docker-images.tgz

wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3528/images-for-eflasher/emmc-flasher-images.tgz
